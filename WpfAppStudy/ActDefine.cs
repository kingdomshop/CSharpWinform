public class ActDefine
{
    ...
    // iQ-R WinCPU
    public const int        CPU_R102WCPU_W = 0x1028;			// R102WCPU_W
    ...
    public const int        CPU_R64MTCPU	= 0x1013;			// R64MTCPU.
    ...
    public const int    UNIT_FXVCCLGN		        = 0x200D;		// FX5-CCLGN-MS
    public const int	UNIT_FXVENET			    = 0x2004;	    // Ethernet(FX5-ENET(/IP)) IP
    public const int	UNIT_FXVENET_DIRECT		    = 0x200E;	    // Ethernet(FX5-ENET(/IP)) DIRECT
    public const int    UNIT_GOT_FXVENET            = 0x2008;	    // GOT Transparent Ethernet(FX5-ENET(/IP))
